...
gulp.task('watch-mode', function() {
  ...
  var indexWatcher = gulp.watch('src/index.html', ['index']);
  var cssWatcher = gulp.watch('src/theme/less/**/*.less', ['css']);
  var imageWatcher = gulp.watch('src/theme/images/', ['image']);
  var testWatcher = gulp.watch('test/**/*.js', ['karma']);
  var fontsWatcher = gulp.watch('src/theme/fonts/', ['fonts']);
  var templateWatcher = gulp.watch('src/template/**/*.*', ['template']);
  var ckeditorWatcher = gulp.watch('src/CKEditor/**/*.*', ['ckeditor']);
...
gulp.task('build', ['css', 'js', 'lint', 'image', 'template', 'index', 'lib', 'fonts', 'ckeditor']);
